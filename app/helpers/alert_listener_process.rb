...
class AlertListenerProcess
    
    PROCESS_NAME = "Alert Listener"
    SERVICE_NAME = "alertlistener"

    BACKEND_EXE = "/usr/local/bin/alertlistener"
    BACKEND_EXE_ARGS = " /usr/local/etc/alertlistener/PGAlertListnerConfig.xml"
